 ...
 */
final class Version20180914130638 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game_slot ADD max_games INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE game CHANGE game_slot_id game_slot_id INT DEFAULT NULL, CHANGE image image VARCHAR(1024) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE game_slot_id game_slot_id INT DEFAULT NULL, CHANGE image image VARCHAR(1024) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE game_slot DROP max_games');
