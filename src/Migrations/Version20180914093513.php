 ...
 */
final class Version20180914093513 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE game_slot_id game_slot_id INT NOT NULL, CHANGE image image VARCHAR(1024) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
